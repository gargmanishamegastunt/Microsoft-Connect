...
window.addEventListener( 'load', () => {
    ...
    if ( !room ) {
        ...
        function init( createOffer, partnerName ) {
            ...
            pc[partnerName].ontrack = ( e ) => {
                ...
                if ( document.getElementById( `${ partnerName }-video` ) ) {
                    ...
                    // newVid.innerHTML = `<span >${username}</span>`;
                    ...
                    // // NameDiv.id = `${document.querySelector( '#username' ).value}`;
        ...
        document.getElementById( 'share-link' ).addEventListener( 'click', ( e ) => {
            h.toggleModal( 'share-link-modal', true )
        ...
        // const button = document.querySelector('#share-button');
            ...
            document.getElementById( 'closeModal' ).addEventListener( 'click', ( e ) => {
                h.toggleModal( 'share-link-modal', false )
            })
        });
